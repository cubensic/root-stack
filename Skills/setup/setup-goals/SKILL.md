...
- **Uncertainty is valid.** If someone says "I have no idea where I'll be in 10 years," that's honest and useful. Write it: "Direction not yet clear — exploring." The weekly-mirror skill will surface themes from their actual behavior over time.
...
- **The self-evolution angle.** The weekly-mirror skill reads 1-year.md when synthesizing the `## Current Focus` section of `me.md`, and can surface gaps between stated goals and actual behavior: "You say growing revenue is a priority, but your last 3 weeks of sessions were all about product features." This is where Rootstack adds real value over a static goal doc.
